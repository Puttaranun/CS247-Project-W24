...
class ResNetLSTM(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv2d(in_channels=img_channels, out_channels=48, kernel_size=(1,3), 
            stride=1, padding='same', bias=False) #22x1000x48
        self.bn1 = nn.BatchNorm2d(48)
        self.relu = nn.ReLU(inplace=True)

        self.conv2 = nn.Conv2d(in_channels=48, out_channels=48, kernel_size=(22,1), 
            stride=1, padding=0, bias=False) #1x1000x48
        ...
        self.avgpool = nn.AvgPool2d(kernel_size=(1,10),stride=1)#144x1x41
        #self.maxpool = nn.MaxPool2d(kernel_size=(1,16))
        self.conv3 = nn.Conv2d(in_channels=96,out_channels=num_classes,kernel_size=(1,1),bias=False) #4x1x41

        self.fc1 = nn.Linear(764, 10)
